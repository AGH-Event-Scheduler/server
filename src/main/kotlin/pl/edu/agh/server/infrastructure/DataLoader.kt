        ...
        organizationRepository.saveAll(
            listOf(
                Organization(
                    name = "KN BIT",
                    isSubscribed = false,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/6vvcu0fN9x6damaH2chW1A/b7a014b13b6e355ccce4196712a5b2b4/bit-logo-black.jpg"),
                ...
                Organization(
                    ...
                    isSubscribed = true,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/6lDoTg2CZHE6PXtFcMN3QU/ff7406cb993c922d0673217941691700/sygnet_z_podpisem_-na_jasne_t_____o-.png"),
                ...
                Organization(
                    ...
                    isSubscribed = true,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/13nZonPMXG0IdiKYepcazY/a75a6f11bc6a4b90d3828acab621e7fa/logo.png"),
                    backgroundImage = createImage("https://skn.agh.edu.pl/static/og-image-c72c98f019ad0e2b3a94f73693f8d457.png"),
                    description = shortLoremIpsum(),
                ),
                Organization(
                    name = "Koło Naukowe Creative",
                    isSubscribed = false,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/2k6DY1kwOBQhahKuCbpIvc/bb03660786772eb34283a43d01f06163/creative_____kopia.jpg"),
                ...
                Organization(
                    ...
                    isSubscribed = false,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/6Clmj70XeHofaHaKs4gk9f/b8cae55e413d98254dc3573e50a50a2c/Logo_kwadrat.jpg"),
                    backgroundImage = createImage("https://energiaimy.pl/wp-content/uploads/2016/03/Eko_flat_left_2.png"),
                    description = mediumLoremIpsum(),
                ),
                Organization(
                    name = "Koło Naukowe Data Team",
                    isSubscribed = true,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/5lCSN4c2tjkX4XrIV0vCB/06b3b3ef735c8e2c0895a3c2284d24d8/338877992_6012870298833520_3324859086898778115_n.jpg"),
                    backgroundImage = createImage("https://opengraph.githubassets.com/78d00acc43ccdc2b371896258fd491689e2081f5475d8a7e4cbbfa45ae3067bf/Kolo-Naukowe-Data-Science-PW/Rekrutacja20"),
                    description = shortLoremIpsum(),
                ),
                Organization(
                    name = "KN 4 Society",
                    isSubscribed = true,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/72PtIIc5egzpyEgYvNBVyD/79a9c93385ce66132e2f6cf1ca0dd746/logo.jpeg"),
                ...
                Organization(
                    name = "KN Energon",
                    isSubscribed = true,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/2hGRA4ipUETBw2l5dpxXFb/a6f465d9ca7566722c19b766f37505f3/LOGO.png"),
                    backgroundImage = createImage("http://www.knpg.agh.edu.pl/wp-content/uploads/2020/01/GLY_5139-1024x683.jpg"),
                    description = mediumLoremIpsum(),
                ),
                Organization(
                    name = "KN Larp AGH",
                    isSubscribed = false,
                    logoImage = createImage("https://images.ctfassets.net/hvenzvkwiy9m/5UnCBCqiKVBYXaUPlNGUuf/89ddbcf2160fe22dd6f320b39ff33bf8/logoAGHsygnet.png"),
